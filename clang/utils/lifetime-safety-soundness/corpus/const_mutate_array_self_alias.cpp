...
// free. The array subscript defeated two AST-shape checks at once:
// handleConstSubversion matched only a direct `this->ptr`, and the
...
// the member `this->arr` at every such site.
